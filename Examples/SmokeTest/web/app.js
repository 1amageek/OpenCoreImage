// OpenCoreImage smoke-test loader.
...
function showError(msg) {
    ...
    console.error("[OCISmoke]", msg);
}

async function main() {
    try {
        setStatus("Loading WASM module...");
        const response = await fetch("OCISmoke.wasm");
        if (!response.ok) {
            throw new Error("Failed to load OCISmoke.wasm: " + response.status);
        }
